...
const includedFeatures = [
  'การพัฒนาเว็บไซต์',
  'การใช้งาน Framework',
  'การพัฒนาเว็บไซต์บนอุปกรณ์เคลื่อนที่',
  'Frontend With React Vue Next ',
]
            ...
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <div class=" text-base font-semibold mt-10 leading-7">
                <div class="w-full bg-gray-200 rounded-full ">
                  <div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full w-[10em]" > 20%</div>
                </div>
              </div>
            </div>
