                    ...
                    <form>
                        <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                <h2 className=" mt-5 text-[2em] leading-6 text-center font-bold  text-[#0F75BE] ">แก้ไขรายวิชา</h2>
                                ...
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 ">
                                    ...
                                    <div className="w-full sm:col-span-2 gap-4">
                                        {variants.map((variant) => (
                                            <div key={variant} className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                                                <Input type="email" variant={variant} label="ชื่อรายวิชา"placeholder="322371 Web Desigh Technologies"/>
                                    ...
                                    <div className="col-span-full">
                                        ...
                                        {variants.map((variant) => (
                                            <div key={variant} className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                                                <Input type="email" variant={variant} label="ชื่อหัวข้อบทเรียน" placeholder="การวางแผนระบบนำทาง "/>
